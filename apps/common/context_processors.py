...
def brand_context(request):
    ...
    return {
        "RUANG_LEGAL_ENTITY_NAME": settings.RUANG_LEGAL_ENTITY_NAME,
        "RUANG_LEGAL_ENTITY_ADDRESS": settings.RUANG_LEGAL_ENTITY_ADDRESS,
        "RUANG_LEGAL_COUNTRY": settings.RUANG_LEGAL_COUNTRY,
        "RUANG_SUPPORT_EMAIL": settings.RUANG_SUPPORT_EMAIL,
        "RUANG_PRIVACY_EMAIL": settings.RUANG_PRIVACY_EMAIL,
        "RUANG_TERMS_URL": settings.RUANG_TERMS_URL,
        "RUANG_PRIVACY_URL": settings.RUANG_PRIVACY_URL,
        "RUANG_TERMS_VERSION": settings.RUANG_TERMS_VERSION,
        "RUANG_PRIVACY_VERSION": settings.RUANG_PRIVACY_VERSION,
        "RUANG_LEGAL_EFFECTIVE_DATE": settings.RUANG_LEGAL_EFFECTIVE_DATE,
        "RUANG_SOURCE_CODE_URL": settings.RUANG_SOURCE_CODE_URL,
        "RUANG_SOURCE_CODE_REVISION": settings.RUANG_SOURCE_CODE_REVISION,
        "RUANG_DEPLOYED_SOURCE_URL": settings.RUANG_DEPLOYED_SOURCE_URL,
        "RUANG_SUBPROCESSORS": settings.RUANG_SUBPROCESSORS,
        "RUANG_ACCOUNT_RECORD_RETENTION_DAYS": settings.RUANG_ACCOUNT_RECORD_RETENTION_DAYS,
        "RUANG_SECURITY_LOG_RETENTION_DAYS": settings.RUANG_SECURITY_LOG_RETENTION_DAYS,
        "RUANG_BACKUP_RETENTION_DAYS": settings.RUANG_BACKUP_RETENTION_DAYS,
    }
